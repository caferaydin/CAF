    ...
    public partial class mig_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CAF_MENU", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CAF_MENU_CAF_MENU_ParentId",
                        column: x => x.ParentId,
                        principalTable: "CAF_MENU",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CAF_PERMISSION", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CAF_PERMISSION_CAF_MENU_MenuId",
                        column: x => x.MenuId,
                        principalTable: "CAF_MENU",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CAF_MENU_ParentId",
                table: "CAF_MENU",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_CAF_PERMISSION_MenuId",
                table: "CAF_PERMISSION",
                column: "MenuId");
        }
